    ...
    return (
        <div className= "min-h-screen flex-col">
            ...
            <div className="flex place-content-evenly flex-col items-center gap-4 w-full h-full bg-gradient-circle ">
                <h2 className="text-center text-4xl mt-4 uppercase tracking-widest text-orangehs">Regístrate</h2>
                <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl m-6 mt-0 p-6 bg-white dark:bg-gray-800 rounded-md shadow-lg backdrop-filter backdrop-blur-sm flex flex-col">
                    <form className="w-full space-y-4" onSubmit={funcCreate}>
                        <div>
                            <label htmlFor="Fname" className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">Nombre</label>
                        ...
                        <div>
                            <label htmlFor="Lname" className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">Apellido</label>
                        ...
                        <div>
                            <label htmlFor="phone" className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">Telefono</label>
                        ...
                        <div>
                            <label htmlFor="email" className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">Correo</label>
                        ...
                        <div>
                            <label htmlFor="password" className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">Contraseña</label>
                        ...
                        <div>
                            <label htmlFor="checkpassword" className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">Confirmar Contraseña</label>
