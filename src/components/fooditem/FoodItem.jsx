...
const FoodItem = ({ id, name, price, description, image, onAddToCart, onRemoveFromCart }) => {
  ...
  return (
    <div className='food-item'>
      <div className="food-item-img-container">
        ...
        {!cartItems[id]
          ? <img className='add' onClick={onAddToCart} src={add_icon} alt="" />
          : <div className='food-item-counter'>
            <img onClick={onRemoveFromCart} src={remove_icon} alt="" />
            <p>{cartItems[id]}</p>
            <img onClick={onAddToCart} src={add_icon_green} alt="" />
          </div>
        }
      </div>
