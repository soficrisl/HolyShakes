    ...
    return (
        <>
            <div className="min-h-screen flex flex-col items-center justify-between bg-gradient-to-b font-montserrat">
                <main className="flex flex-col items-center w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl p-4">
                    ...
                    <form className="w-full space-y-4" onSubmit={funcAutentication}>
                        <div>
                            <label htmlFor="email" className="block text-sm text-zinc-700 dark:text-zinc-300 font-bold">Correo</label>
                        ...
                        <div>
                            <label htmlFor="password" className="block text-sm text-zinc-700 dark:text-zinc-300 font-bold">Contraseña</label>
                    ...
                    <Link to="/LoginAdmin" className="w-full py-2 mt-2 border border-orange-500 text-orange-500 rounded-md text-center hover:bg-orange-100 dark:border-orange-400 dark:text-orange-400 dark:hover:bg-orange-600">Inicio Admin</Link>
                </main>
            </div>
        </>
    );
